    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(related_name='item_physdesc', blank=True, to='catalogue.BasicArchiveModel', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='PhysDescType',
        ...
        migrations.AddField(
            model_name='note',
            name='item',
            field=models.ForeignKey(related_name='item_note', blank=True, to='catalogue.BasicArchiveModel', null=True),
        ),
        migrations.AddField(
            model_name='note',
            name='type',
