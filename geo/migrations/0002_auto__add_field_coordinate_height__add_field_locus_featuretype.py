...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Coordinate.height'
        db.add_column('geo_coordinate', 'height',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=7),
                      keep_default=False)

        # Adding field 'Locus.featuretype'
        db.add_column('geo_locus', 'featuretype',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Coordinate.height'
        db.delete_column('geo_coordinate', 'height')

        # Deleting field 'Locus.featuretype'
        db.delete_column('geo_locus', 'featuretype')
