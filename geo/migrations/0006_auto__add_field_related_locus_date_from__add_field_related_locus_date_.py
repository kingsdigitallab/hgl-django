...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Related_Locus.date_from'
        db.add_column('geo_related_locus', 'date_from',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Related_Locus.date_to'
        db.add_column('geo_related_locus', 'date_to',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Related_Locus.date_from'
        db.delete_column('geo_related_locus', 'date_from')

        # Deleting field 'Related_Locus.date_to'
        db.delete_column('geo_related_locus', 'date_to')
